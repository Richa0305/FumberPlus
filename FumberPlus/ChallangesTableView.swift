...
class ChallangesTableView: UITableView,UITableViewDelegate,UITableViewDataSource {
    var items: [String] = ["Challange 1 - Small Targets in 10sec", "Challange 2 - More in 10sec", "Challange 3 - Big Targets in 20sec", "Challange 4 - Bigger n Better", "Challange 5 - Huge Numbers", "Challange 6 - Think Fast", "Challange 7 - Think Faster", "Challange 8 - The Final Challange"]
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if cell.textLabel?.text == "Challange 1 - Small Targets in 10sec"{
            ...
            else if cell.textLabel?.text == "Challange 3 - Big Targets in 20sec"{
                if highScore >= 60  {
                    cell.imageView?.image =  UIImage(named: "unlocked")
                    cell.contentView.alpha = 1
                }else{
